...
function predecir() {
	if (modelo != null) {
	resample_single(canvas, 300, 300, otrocanvas);

	//Hacer la predicción
	// Hacer la predicción (Make the prediction)
	...
	// Ajusta la forma del tensor para que coincida con [null, 300, 300, 3]
	var tensorAjustado = tf.image.resizeBilinear(tensor, [300, 300]);

	// Ahora el tensorAjustado tiene la forma [1, 300, 300, 3] y puedes pasarlo al modelo para la predicción

	var resultado = modelo.predict(tensor).dataSync();
	// Encontrar la clase con la máxima probabilidad
	...
	'ZEBRA DOVE'];
	var respuesta = clases[maxProbIndex];
